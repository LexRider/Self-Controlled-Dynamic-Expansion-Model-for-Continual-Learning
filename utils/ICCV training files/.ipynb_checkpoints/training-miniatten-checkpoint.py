...
# training graph attention 2bb, 每个任务使用大的分类头
...
def train(model: ContinualModel, dataset: ContinualDataset,
    ...
    with track_system_stats(logger) as system_tracker:
        ...
        for t in range(start_task, end_task):
            ...
            model.new_attention_layer(train_loader, args.lr)
            ...
            # 更新模型的优化器
            model.update_optimizer(train_loader = train_loader)
            if t == 1:
